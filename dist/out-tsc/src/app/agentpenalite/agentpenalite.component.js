...
var AgentpenaliteComponent = /** @class */ (function () {
    function AgentpenaliteComponent() {
    ...
    AgentpenaliteComponent.prototype.ngOnInit = function () {
        this.remplirAnnee();
        console.log(this.annee);
    };
    AgentpenaliteComponent.prototype.remplirAnnee = function () {
        for (var i = 1; i <= 10; i++) {
            var y = 2019 + i;
            this.annee.push(y.toString());
        }
    };
    AgentpenaliteComponent = tslib_1.__decorate([
        Component({
            selector: 'app-agentpenalite',
            templateUrl: './agentpenalite.component.html',
            styleUrls: ['./agentpenalite.component.css']
        }),
        tslib_1.__metadata("design:paramtypes", [])
    ], AgentpenaliteComponent);
    return AgentpenaliteComponent;
}());
export { AgentpenaliteComponent };
//# sourceMappingURL=agentpenalite.component.js.map