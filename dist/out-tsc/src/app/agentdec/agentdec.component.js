...
var AgentdecComponent = /** @class */ (function () {
    function AgentdecComponent() {
    ...
    AgentdecComponent.prototype.ngOnInit = function () {
        this.remplirAnnee();
        console.log(this.annee);
    };
    AgentdecComponent.prototype.remplirAnnee = function () {
        for (var i = 1; i <= 10; i++) {
            var y = 2019 + i;
            this.annee.push(y.toString());
        }
    };
    AgentdecComponent = tslib_1.__decorate([
        Component({
    ...
    return AgentdecComponent;
}());
export { AgentdecComponent };
//# sourceMappingURL=agentdec.component.js.map